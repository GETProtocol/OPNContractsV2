...
contract Auth is IAuth, AccessControlUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function __Auth_init_unchained(address _owner, address _eventFactory, address _topUp) internal initializer {
        ...
        _setupRole(_EVENT_FACTORY_ROLE, _eventFactory);
    ...
    function setRoleAdmins(address _owner, address _routerRegistry, address _economicsFactory) external onlyOwner {
        ...
        _setupRole(_PROTOCOL_DAO_ROLE, _owner);
        _setupRole(_EFM_ROLE_INTEGRATOR, _owner);
        _setupRole(_ECONOMICS_INTEGRATOR_ROLE, _owner);
        _setupRole(_ROUTER_REGISTRY_ROLE, _routerRegistry);
        _setupRole(_FUEL_ROUTER_ROLE, _owner);
        _setupRole(_ECONOMICS_FACTORY_ROLE, _economicsFactory);
