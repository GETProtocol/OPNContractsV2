...
import { ERC20PresetMinterPauser, ERC20Burnable, ERC20 } from "@openzeppelin/contracts/token/ERC20/presets/ERC20PresetMinterPauser.sol";
import { ITestERC20Decimals } from "./interfaces/ITestERC20Decimals.sol";

// prettier-ignore
contract TestERC20Decimals is ITestERC20Decimals, Context, ERC20Burnable {
